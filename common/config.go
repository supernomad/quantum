...
type Config struct {
	...
	DatastoreRefreshInterval time.Duration          `internal:"false"  type:"duration"  short:"ri"   long:"datastore-refresh-interval"  default:"120s"                  description:"The interval of dhcp lease refreshes with the datastore."                                                                     section:"Datastore"  name:"Datastore Lease Rfresh Interval"`
