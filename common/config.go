...
type Config struct {
	...
	QuicSkipVerify           bool                   `internal:"false"  type:"bool"      short:"qsv"  long:"quic-skip-verify"            default:"false"                 description:"Whether or not to authenticate the Quic certificates when using the Quic backend."`
	QuicCA                   string                 `internal:"false"  type:"string"    short:"qca"  long:"quic-ca-cert"                default:""                      description:"The Quic CA certificate to authenticate the Quic certificates when using the Quic backend."`
	QuicCert                 string                 `internal:"false"  type:"string"    short:"qc"   long:"quic-cert"                   default:""                      description:"The Quic client certificate to use to authenticate when using the Quic backend."`
	QuicKey                  string                 `internal:"false"  type:"string"    short:"qk"   long:"quic-key"                    default:""                      description:"The Quic client key to use to authenticate when using the Quic backend."`
